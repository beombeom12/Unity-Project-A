...
public class UpShotWeapon1 : MonoBehaviour
{
    public static UpShotWeapon1 Instance
    {
        get
        {
            if (UpShotWeaponInstance1 == null)
            {
                UpShotWeaponInstance1 = FindObjectOfType<UpShotWeapon1>();
                if (UpShotWeaponInstance1 == null)
                {
                    var InstanceContainer = new GameObject("UpShotWeapon1");
                    UpShotWeaponInstance1 = InstanceContainer.AddComponent<UpShotWeapon1>();
                }
            }
            return UpShotWeaponInstance1;
        }
    }


    private static UpShotWeapon1 UpShotWeaponInstance1;

...
public class UpShotWeapon : MonoBehaviour
{
    public static UpShotWeapon Instance
    {
        get
        {
            if (UpShotWeaponInstance == null)
            {
                UpShotWeaponInstance = FindObjectOfType<UpShotWeapon>();
                if (UpShotWeaponInstance == null)
                {
                    var InstanceContainer = new GameObject("UpShotWeapon");
                    UpShotWeaponInstance = InstanceContainer.AddComponent<UpShotWeapon>();
                }
            }
            return UpShotWeaponInstance;
        }
    }


    private static UpShotWeapon UpShotWeaponInstance;

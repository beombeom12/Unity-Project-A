...
public class SmallWarriorSkeleton : GhostFSM
{
    public static SmallWarriorSkeleton Instance
    {
        get
        {
            if (SmallWarriorSkeletonInstance == null)
            {
                SmallWarriorSkeletonInstance = FindObjectOfType<SmallWarriorSkeleton>();
                if (SmallWarriorSkeletonInstance == null)
                {
                    var InstanceContainer = new GameObject("SmallWarriorSkeleton");
                    SmallWarriorSkeletonInstance = InstanceContainer.AddComponent<SmallWarriorSkeleton>();
                }
            }
            return SmallWarriorSkeletonInstance;
        }
    }
    private static SmallWarriorSkeleton SmallWarriorSkeletonInstance;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.transform.CompareTag("Weapon"))
        {
            ...
            if (Random.value < 0.6)
            {
                ...
                WarriorSkeletonCanvas.GetComponent<SmallWarriorSkeletonHpBar>().Damage(fWeaponDamage);
            ...
            else
            {
                ...
                WarriorSkeletonCanvas.GetComponent<SmallWarriorSkeletonHpBar>().Damage(fWeaponDamage * fWeaponCritical);
        ...
        if (other.gameObject.CompareTag("BowWeapon"))
        {
            ...
            if (Random.value < 0.6)
            {
                ...
                WarriorSkeletonCanvas.GetComponent<SmallWarriorSkeletonHpBar>().Damage(fBowWeaponDamage);
            ...
            else
            {
                ...
                WarriorSkeletonCanvas.GetComponent<SmallWarriorSkeletonHpBar>().Damage(fBowWeaponDamage * fWeaponCritical);
        ...
        if (other.transform.CompareTag("SphereWeapon"))
        {
            ...
            WarriorSkeletonCanvas.GetComponent<SmallWarriorSkeletonHpBar>().Damage(fSphereWeaponDamage);
        ...
        if (other.transform.CompareTag("BatPetWeapon"))
        {
            ...
            WarriorSkeletonCanvas.GetComponent<SmallWarriorSkeletonHpBar>().Damage(fBatPetWeaponDamage);

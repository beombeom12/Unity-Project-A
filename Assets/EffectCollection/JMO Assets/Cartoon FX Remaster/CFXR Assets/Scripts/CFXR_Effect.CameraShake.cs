...
namespace CartoonFX
{
    ...
    {
        public static CFXR_Effect Instance
        {
            get
            {
                if (CFXP_EffectInstance == null)
                {
					CFXP_EffectInstance = FindObjectOfType<CFXR_Effect>();
                    if (CFXP_EffectInstance == null)
                    {
                        var InstanceContainer = new GameObject("CFXR_Effect");
						CFXP_EffectInstance = InstanceContainer.AddComponent<CFXR_Effect>();
                    }
                }
                return CFXP_EffectInstance;
            }
        }

        private static CFXR_Effect CFXP_EffectInstance;
